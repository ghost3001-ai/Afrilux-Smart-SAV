...
EMAIL_BACKEND = "sav.email_backend.AfriluxSMTPEmailBackend"
...
EMAIL_RELAX_X509_STRICT = _env_bool("EMAIL_RELAX_X509_STRICT", False)
...
SAV_SHELL_CACHE_SECONDS = int(os.getenv("SAV_SHELL_CACHE_SECONDS", "30"))
SAV_DASHBOARD_CACHE_SECONDS = int(os.getenv("SAV_DASHBOARD_CACHE_SECONDS", "60"))
SAV_REALTIME_STREAM_SECONDS = int(os.getenv("SAV_REALTIME_STREAM_SECONDS", "25"))
SAV_REALTIME_POLL_SECONDS = float(os.getenv("SAV_REALTIME_POLL_SECONDS", "2"))
if REDIS_URL:
    CACHES = {
        "default": {
